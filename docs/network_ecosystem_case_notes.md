...
| Anchor | Current value | How to say it safely |
|---|---:|---|
...
Use the CSV table `docs/network_ecosystem_case_notes.csv` for machine-readable rows. A compact version is below.
...
- Stretch issue: #88
- Page module: `#network`
- Related handoff: `docs/network_visual_presentation_handoff.md`
