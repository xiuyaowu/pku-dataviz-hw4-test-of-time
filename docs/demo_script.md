...
> 总结来看，经得起时间检验的研究通常需要多维观察。它可能经历较长 recognition lag，出现在特定学术社区和主题演化节点上，在引用轨迹中持续累积影响，并通过机构和地区网络扩散。我们的可视化把“长期影响”拆成时间、领域、主题、引用、证据检索和网络六个可观察维度，同时保留具体论文案例供进一步解释。
