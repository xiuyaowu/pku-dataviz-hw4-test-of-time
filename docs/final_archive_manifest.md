...
| Data provenance and limitations | `docs/data_dictionary.md`, `docs/data_provenance_audit.md`, `docs/time_data_quality_audit.md`, `docs/evidence_coverage_matrix.md`, `docs/uncertainty_proxy_confidence_playbook.md`, `docs/final_evidence_verification_queue.md` |
