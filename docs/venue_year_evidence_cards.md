...
Purpose: give the C / Venue and Field owner a short, source-traceable card set for turning aggregate venue charts into concrete report and presentation examples. This extends the earlier mini case-study page with a machine-readable card table and explicit safe wording for each case.

Source table: `docs/venue_year_evidence_cards.csv`  
...
- [ ] Keep at least one denominator caveat from `docs/venue_normalization_count_guide.md` when discussing raw venue counts.
- [ ] If using a CV or IR high-citation case, include one sentence that citation/breadth are descriptive proxy metrics.

## Related files

- `docs/venue_field_handoff.md`: main C module handoff and report paragraph.
- `docs/venue_year_case_studies.md`: earlier shorter case-study shortlist.
- `docs/venue_source_traceability_audit.md`: venue-level source and coverage checks.
- `docs/venue_normalization_count_guide.md`: denominator caveats for raw counts.
- `docs/final_report_figure_evidence_index.md`: map from D3 modules to report evidence.
