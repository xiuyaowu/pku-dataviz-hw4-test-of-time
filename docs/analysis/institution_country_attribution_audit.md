...
| Check | Current value | Recommended wording |
|---|---:|---|
...
Machine-readable table: `docs/analysis/institution_country_attribution_audit.csv`.

| Case type | Paper id | Title | Venue/year | Why notable | Careful wording |
|---|---|---|---|---|---|
...
- Use this audit together with `docs/analysis/network_ecosystem_case_notes.md` and `docs/methodology/uncertainty_proxy_confidence_playbook.md`.
