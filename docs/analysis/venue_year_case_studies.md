...
Source table: `docs/analysis/venue_year_case_studies.csv`  
...
- If adding slide bullets, copy the careful wording from this page rather than rewriting as a venue ranking.
