...
Purpose: provide a report-ready bridge between automatic topic labels and manually reviewed representative-paper labels. It should be read together with `docs/analysis/manual_topic_audit_top12.md` and `docs/analysis/topic_venue_crosswalk.md`.
...
| API topic label | Papers | Top-12 audited | Corrected rows | Review priority | Careful wording boundary |
|---|---:|---:|---:|---|---|
...
## module owner review queue

- **Computer Vision** (43 papers): module owner should verify corrected / needs-review cases before using them as slide examples.
- **Natural Language Processing** (26 papers): module owner should verify corrected / needs-review cases before using them as slide examples.
- **Machine Learning Theory** (18 papers): module owner should verify corrected / needs-review cases before using them as slide examples.
- **Human-Computer Interaction** (13 papers): module owner should verify corrected / needs-review cases before using them as slide examples.
- **Database / Systems** (67 papers): Keep evidence URLs open when converting the checked cases into final prose.
- **Data Mining / Web** (46 papers): module owner should verify corrected / needs-review cases before using them as slide examples.
...
- Pick 5–8 final paper examples and verify their evidence URLs.
