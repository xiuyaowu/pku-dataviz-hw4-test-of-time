...
Purpose: give C a compact, report-ready explanation for why venue and field counts are imbalanced, and how to describe that imbalance without turning it into a venue ranking. Final human case checks remain noted at the end of this page.
...
- 若引用 2–3 个 venue-year 案例，先核对 `docs/analysis/venue_year_case_studies.md` 中对应论文页面或 award citation。
