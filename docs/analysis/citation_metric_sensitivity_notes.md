...
- `docs/analysis/citation_metric_sensitivity_notes.csv`: 10 representative sensitivity rows generated from the current master data.

Computed baseline from the current master table:

| Metric | Current anchor | Recommended wording |
|---|---:|---|
...
`docs/analysis/citation_metric_sensitivity_notes.csv` contains 10 rows across five case types:
...
- Pick 2-3 final examples for slides from `docs/analysis/citation_metric_sensitivity_notes.csv`.
