...
This audit supports the Venue / Field module by turning the venue aggregate chart into a provenance-aware report asset. It is computed from `data/papers_enriched.csv` and exported as `docs/analysis/venue_source_traceability_audit.csv`.
...
## How module owner should use this
...
- Pick 2-3 venue rows from `docs/analysis/venue_source_traceability_audit.csv` for final slides.
