...
Purpose: provide Issue #61 / E owner with a report-ready classification of citation-trajectory shapes. The underlying data is `data/citation_trajectories.csv` plus citation depth/breadth fields from `data/papers_enriched.csv`. The machine-readable candidate table is `docs/citation_trajectory_archetypes.csv`.

## Method and safe wording
...
## Remaining human checks for Issue #61
