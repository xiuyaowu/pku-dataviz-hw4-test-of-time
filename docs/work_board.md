...
新增有意义任务不直接替代 #2-#7，而是作为各 owner 的加分任务保留在 `docs/stretch_issue_assignment_board.md`。当前路由：A → #53/#54/#52，B → #55/#56/#46，C → #57/#58/#50，D → #59/#60/#47，E → #61/#62/#49，F → #63/#64/#48/#51，跨模块 Story Builder → #45。#61 的 trajectory archetype 候选表见 `docs/citation_trajectory_archetypes.md` / `.csv`。A 的 PR review rubric 与合并标准见 `docs/pr_review_rubric.md`。
