...
| F · Visual / Presentation | #7 | #63, #64, #48, #51, #88 | Visual consistency (`docs/slide_visual_consistency_audit.md`), live-demo fallback, defense Q&A (`docs/defense_qa_pack.md`), metric glossary (`docs/glossary_metric_explainer.md` + page Glossary section), Network ecosystem cases (`docs/network_ecosystem_case_notes.md`) |
...
3. #90 Venue source traceability audit and #96 venue normalization/count guide: gives C provenance plus denominator-aware language for venue-count and field-distribution defense.
4. #48 Defense Q&A: prepares answers for teacher questions.
5. #47 / #61 / #55 / #56 / #60 / #98: gives D/E/B stronger analytical findings, topic-shift narrative material, and screenshot-ready explanations.
