...
| D · Topic Evolution | #5 | #59, #60, #47, #100, #114 | Manual topic audit (`docs/manual_topic_audit_top12.md`), topic-shift narrative (`docs/topic_shift_narrative.md`), research archetype taxonomy (`docs/research_archetype_taxonomy.md`), topic presentation case shortlist (`docs/topic_presentation_case_shortlist.md`), topic × venue crosswalk (`docs/topic_venue_crosswalk.md`) |
| E · Citation / Impact | #6 | #61, #62, #49, #86, #110, #116 | Citation trajectory archetypes (`docs/citation_trajectory_archetypes.md`), impact breadth audit (`docs/impact_breadth_evidence_audit.md`), evidence coverage matrix (`docs/evidence_coverage_matrix.md`), uncertainty / proxy-confidence playbook (`docs/uncertainty_proxy_confidence_playbook.md`), final case-selection risk register (`docs/final_case_selection_risk_register.md`), citation metric sensitivity notes (`docs/citation_metric_sensitivity_notes.md`) |
...
2. #49 Evidence coverage matrix, #86 uncertainty playbook, #108 final report claim bank, #110 final case-selection risk register, and #116 citation metric sensitivity notes: expose manual gaps, give the team safe proxy-confidence wording, convert evidence docs into copy-ready final report claims, and help E choose safer representative cases without over-relying on one metric.
...
5. #47 / #100 / #61 / #55 / #56 / #60 / #98 / #112 / #118: gives D/E/B stronger analytical findings, topic-to-venue bridge material, topic-shift narrative material, screenshot-ready explanations, Time cohort-comparison context, and Time data-quality boundaries.
