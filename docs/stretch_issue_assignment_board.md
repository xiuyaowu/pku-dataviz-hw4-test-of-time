...
2. #49 Evidence coverage matrix, #86 uncertainty playbook, #108 final report claim bank, #110 final case-selection risk register, #116 citation metric sensitivity notes, and #122 final submission readiness scorecard: expose manual gaps, give the team safe proxy-confidence wording, convert evidence docs into copy-ready final report claims, help E choose safer representative cases without over-relying on one metric, and give A one final pass/warn/blocker review page.
