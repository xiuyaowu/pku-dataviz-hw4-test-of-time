...
本仓库主要使用 `data/` 目录下的 CSV 文件。以下是常用文件和字段说明。指标口径的统一说明见 `docs/data_provenance_audit.md`；最终报告中应沿用这里的定义，不把公开元数据 proxy 写成官方评奖原因或因果结论。
...
| Manual annotation | 队友补充的贡献解释、工业影响、evidence URL | 单篇论文贡献和工业/基础设施影响必须由人工证据支撑。 |
