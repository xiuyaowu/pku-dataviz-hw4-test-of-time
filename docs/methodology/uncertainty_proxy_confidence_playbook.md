...
Purpose: give the module owner and final presenters one neutral page for explaining which claims are directly data-backed, which are proxy-based, and which still need human evidence review. Use this together with `docs/analysis/impact_breadth_evidence_audit.md`, and `docs/methodology/glossary_metric_explainer.md`.

## 1. Current coverage snapshot

| Evidence layer | Current coverage | Confidence for report/PPT | Careful wording |
|---|---:|---|---|
...
| Top 12 final human check | 0 / 12 marked fully final; 12 / 12 marked partial or needs final check | Requires annotator review | “Representative case wording remains draft until the owner checks paper/award evidence.” |
...
| Institution/country attribution | Network module | Institution/country counts show visible metadata distribution. | Do not write institutional ranking, national strength ranking, or exact collaboration network. | F checks final slide wording against the network analysis notes. |
...
- Final check: confirm this playbook is consistent with README, the report skeleton, and the citation/impact analysis notes.
