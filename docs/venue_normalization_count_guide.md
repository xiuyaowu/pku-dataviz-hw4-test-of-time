...
| Venue | Raw count rank | Normalized signal | How to say it safely | Human check |
|---|---:|---|---|---|
...
- [ ] Choose 2-3 venues for final slides and verify their paper or award links in `docs/venue_source_traceability_audit.csv`.
